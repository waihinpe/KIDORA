    ...
    switch (activeModal) {
      case 'buying':
        return (
          <div className="space-y-4">
            {[
              { id: '1', title: 'Bugaboo Fox 3 Stroller', price: 22500, date: 'Oct 12, 2023', status: 'Delivered', img: 'https://images.unsplash.com/photo-1591084728795-1149fb3a288d?auto=format&fit=crop&w=200&q=80' },
              { id: '2', title: 'Lovevery Play Gym', price: 2800, date: 'Sep 28, 2023', status: 'Delivered', img: 'https://images.unsplash.com/photo-1596464716127-f2a82984de30?auto=format&fit=crop&w=200&q=80' }
            ].map(item => (
              <div key={item.id} className="flex gap-4 p-4 bg-white border border-gray-100 rounded-3xl shadow-sm">
                ...
                <div className="flex-1 py-1">
                  ...
                  <p className="text-xs font-black text-gray-900 mb-2">THB {item.price}</p>
      ...
      case 'selling':
        return (
          <div className="space-y-4">
            {[
              { id: '1', title: 'Stokke Tripp Trapp Chair', price: 7200, views: 142, status: 'In Transit', img: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&w=200&q=80' },
              { id: '2', title: 'Ergobaby Omni 360', price: 2400, views: 56, status: 'Listed', img: 'https://images.unsplash.com/photo-1602738328654-51ab2330b8b4?auto=format&fit=crop&w=200&q=80' }
            ].map(item => (
              <div key={item.id} className="flex gap-4 p-4 bg-white border border-gray-100 rounded-3xl shadow-sm">
                <img src={item.img} className="w-20 h-20 rounded-2xl object-cover bg-gray-50 shrink-0 border border-gray-100" alt={item.title} />
                <div className="flex-1 py-1">
      ...
      <div className="px-6 mb-8">
        <div className="bg-gray-900 rounded-[40px] p-8 text-white flex justify-between items-center">
            <div>
                ...
                <p className="text-3xl font-bold">THB {user.totalEarnings.toLocaleString()}</p>
            </div>
