...
const SustainabilityScreen: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-full">
      {/* Header - Sticky */}
      <div className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-gray-100 px-6 py-6 flex flex-col space-y-2">
      ...
      <div className="flex-1 flex flex-col space-y-8 px-6 pb-24 pt-8">
        {/* Content goes here */}
